...
ne = make_query_operator('exact', transform=operators['not'])
...
true = make_query_operator('exact', value=True, can_invert=False)
false = make_query_operator('exact', value=False, can_invert=False)
...
def make_query_operator(name, can_invert=True, inverse=None, transform=None, value=None):
